...
**Context:** Consider running this in a dedicated worktree for substantial changes. A worktree is optional — use one when the user requests isolation or the change spans multiple files/tasks.
